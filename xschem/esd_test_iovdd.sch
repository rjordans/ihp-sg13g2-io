...
N 1890 -240 1890 -210 {lab=GND}
N 1400 -360 1400 -340 {lab=vswitch}
N 1380 -360 1380 -340 {lab=GND}
N 1340 -360 1380 -360 {lab=GND}
N 1870 -240 1890 -240 {lab=GND}
N 1890 -280 1890 -240 {lab=GND}
N 1870 -280 1890 -280 {lab=GND}
N 1870 -260 2110 -260 {lab=iovdd}
N 1870 -300 1930 -300 {lab=vdd}
N 1040 -300 1150 -300 {lab=esd_precharge}
N 1210 -300 1370 -300 {lab=esd}
N 1560 -300 1640 -300 {lab=iovdd}
...
C {gnd.sym} 1890 -210 0 0 {name=l2 lab=GND}
C {launcher.sym} 280 -110 0 0 {name=h2
...
"
"}
C {devices/launcher.sym} 280 -70 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/esd_test_iovdd.raw tran"
}
...
C {lab_pin.sym} 2110 -260 0 1 {name=p3 lab=iovdd}
...
C {sg13g2_IOPadIOVdd.sym} 1760 -270 0 0 {name=x2}
...
C {vsource.sym} 1310 -430 0 0 {name=V5 value="PULSE(0 1.2 0.1u 1n 1n 1u 20u 1)" savecurrent=false}
...
device=resistor
m=1}
C {lab_pin.sym} 1930 -300 0 1 {name=p4 lab=vdd}
C {res.sym} 2080 -230 0 0 {name=R2
value=1MEG
footprint=1206
device=resistor
m=1}
C {gnd.sym} 2080 -200 0 0 {name=l4 lab=GND}
C {capa-2.sym} 1990 -230 0 0 {name=C2
m=1
value=500f
footprint=1206
device=polarized_capacitor}
C {gnd.sym} 1990 -200 0 0 {name=l5 lab=GND}
C {simulator_commands_shown.sym} -580 -780 0 0 {name=Simulator
simulator=xyce
only_toplevel=false 
value="
...
.option temp=27
.tran 0.1n 2u
.print tran format=raw file=esd_test_iovdd.raw V(*) I(C1)
"
}
C {simulator_commands_shown.sym} -580 -480 0 0 {name=Libs_Xyce
simulator=xyce
only_toplevel=false 
value="tcleval(
...
C {launcher.sym} -520 -140 0 0 {name=h1
descr=SimulateXyce
tclcommand="
# Setup the default simulation commands if not already set up
# for example by already launched simulations.
